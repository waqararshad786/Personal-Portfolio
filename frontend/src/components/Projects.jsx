  ...
  const staticProjects = [
    {
      ...
      description:
        'Full-featured e-commerce platform with cart, auth, payments.',
    ...
    },
    {
      ...
      description:
        'Room booking, admin dashboard, availability calendar.',
    ...
    },
    {
      ...
      title: 'AI HRM System',
      description:
        'HR platform with AI-powered resume screening.',
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {filteredProjects.map((project) => {
            const projectImage =
              projectImages[project.title] || clothingImg;
